...
) => Promise<TestHttpHandlerResult> | TestHttpHandlerResult;
...
export class TestHttpClient extends HttpClient {
  ...
  public on(
    methodOrHandler: string | RegExp | TestHttpHandler,
    urlOrHandler?: string | RegExp | TestHttpHandler,
    handler?: TestHttpHandler,
  ): TestHttpClient {
    ...
    if (
      ...
      methodOrHandler instanceof RegExp
    ) {
