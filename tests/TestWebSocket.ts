...
export class TestWebSocket {
  ...
  public close(code?: number | undefined, reason?: string | undefined): void {
    ...
    this.readyState = this.CLOSED;
    this.onclose((closeEvent as unknown) as Event);
  }
  ...
  public addEventListener<K extends "close" | "error" | "message" | "open">(
    type: K,
  ...
  public removeEventListener<K extends "close" | "error" | "message" | "open">(
    type: K,
    listener: (this: WebSocket, ev: WebSocketEventMap[K]) => any,
